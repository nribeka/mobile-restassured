...
public class ConfigServiceImpl implements ConfigService {
     ...
     */
    @Override
    public void registerAlgorithm(final Class clazz, final Algorithm algorithm) {
        SearchObjectFactory.getInstance().addAlgorithm(clazz, algorithm);
    }
     ...
     */
    @Override
    public void registerConfiguration(final JsonLuceneConfig... config) {
    }
}
